...
<div class="languages">
    ...
    <a href="{{route('change-locale', $locale['code'])}}" class="{{(app()->getLocale()==$locale['code'])?'language-active':''}}">
        <img src="{{asset('assets/img/flags/'.$locale['flag'])}}" alt="">{{$locale['name']}}
    </a>
    @endforeach
</div>
<!-- Preloader Start -->
                ...
                <div class="container">
                    <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="d-sm-block d-none header-info-left">
                                <ul>
                                    <li class="title"><span class="flaticon-energy"></span> {{__('trending-title')}}</li>
                                ...
                                <ul class="header-date">
                                    ...
                                    <li>
                                        ...
                                        <a href="{{route('admin.index')}}">
                                            <span class="fa fa-cogs"></span>{{__('Dashboard')}}
                                        </a>
                                        @elseif(isPublicWriter())
                                        <a href="#">
                                            <span class="fa fa-cogs"></span>{{__('Dashboard')}}
                                        </a>
                                        @endif
                                    ...
                                    <li>
                                        <a href="#" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();" role="button"><span class="fa fa-power-off"></span>{{__('Logout')}}</a>
                                    ...
                                    @else
                                        <li>
                                            <a href="{{route('login', app()->getLocale() )}}">
                                                <span class="fa fa-sign-in-alt"></span>{{__('Login')}}
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    @if(auth()->user())
                                        @if(!isPublicWriter() && (!isAdmin() && !isWritter()))
                                            <li>
                                                <a href="#">
                                                    <span class="fa fa-edit"></span>{{__('Become a writer')}}
                                                </a>
                                            </li>
                                        @endif
                                    @endif
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="assets/img/gallery/header_card.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-xl-12 ">
                            <div class="footer-copy-right text-center">
                                <p>{{__('Copyright © 2020 All rights reserved')}} | {{__('Muslim Press')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
